...
namespace CandlestickVisualization
{
    public static class ChartRenderer
    {
        ...
        public static void Render(Chart chart, List<Candlestick> candlesticks)
        {
            ...
            foreach (var candle in candlesticks)
            {
                var pricePoint = new DataPoint
                {
                    ...
                    YValues = new[]
                    {
                        (double)candle.MaximumPrice,
                        (double)candle.MinimumPrice,
                        (double)candle.OpeningPrice,
                        (double)candle.ClosingPrice
                    }
                };
        ...
        private static void NormalizeAxes(Chart chart, List<Candlestick> candlesticks)
        {
            ...
            decimal maxPrice = candlesticks.Max(c => c.MaximumPrice);
            decimal minPrice = candlesticks.Min(c => c.MinimumPrice);
